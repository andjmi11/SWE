...
builder.Services.AddTransient<NotificationMessageService>();
builder.Services.AddTransient<OsobljeProstorijaRService>();
builder.Services.AddTransient<NotifikacijaStudentService>();
builder.Services.AddTransient<NotificationMessageProfService>();
builder.Services.AddTransient<ObjavaStudentService>();
