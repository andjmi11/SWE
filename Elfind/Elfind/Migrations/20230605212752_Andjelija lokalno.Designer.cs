...
namespace Elfind.Migrations
{
    ...
    [Migration("20230605212752_Andjelija lokalno")]
    partial class Andjelijalokalno
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elfind.Data.Model.Notifikacija", b =>
                {
                    ...
                    b.HasOne("Elfind.Data.Model.Objava", "ZaObjavu")
                        .WithMany()
                        .HasForeignKey("ZaObjavuID");

                    b.Navigation("Posiljalac");

                    b.Navigation("ZaObjavu");
                });
            ...
            modelBuilder.Entity("Elfind.Data.Models.NotifikacijaStudent", b =>
                {
                    b.HasOne("Elfind.Data.Model.Notifikacija", "Notifikacija")
                        .WithMany("Studenti")
