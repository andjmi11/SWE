...
{
    /// <inheritdoc />
    public partial class Andjelijalokalno : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZaObjavuID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Notifikacije_Objave_ZaObjavuID",
                        column: x => x.ZaObjavuID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotifikacijaStudent_Notifikacije_NotifikacijaID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotifikacijaStudent_NotifikacijaID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifikacije_ZaObjavuID",
                table: "Notifikacije",
                column: "ZaObjavuID");
